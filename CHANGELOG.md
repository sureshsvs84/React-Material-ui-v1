...
### Major style changes
- `src/assets/theme/material-base-theme/components/tasksStyle.jsx`
- `src/assets/theme/material-base-theme/checkboxAdnRadioStyle.jsx`
- `src/assets/theme/material-base-theme/components/customTabsStyle.jsx`
- `src/assets/theme/material-base-theme/components/snackbarContentStyle.jsx`
...
### Major style changes
- `src/assets/theme/material-base-theme/components/footerStyle.jsx`
- `src/assets/theme/material-base-theme/components/headerStyle.jsx`
### Added dependencies
- `@babel/runtime v7.0.0-beta.55`
### Update dependencies
...
- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/theme/material-base-theme/views/dashboardStyle.jsx`
  - `src/assets/theme/material-base-theme/components/buttonStyle.jsx`
  - `src/assets/theme/material-base-theme/components/cardFooterStyle.jsx`
  - `src/assets/theme/material-base-theme/components/cardHeaderStyle.jsx`
  - `src/assets/theme/material-base-theme/components/headerLinksStyle.jsx`
  - `src/assets/theme/material-base-theme/components/customTabsStyle.jsx`
- Others
  - `src/assets/theme/material-base-theme/tooltipStyle.jsx`
  - `src/assets/theme/material-base-theme/dropdownStyle.jsx`
### Dropped components
...
### Major style changes
- Moved the styles of `src/components/` inside `src/assets/theme/material-base-theme/components/`
- Moved the styles of `src/layouts/` inside `src/assets/theme/material-base-theme/layouts/`
- Moved the styles of `src/views/` inside `src/assets/theme/material-base-theme/views/`
...
- Renamed `src/variables/styles.jsx` to `src/assets/theme/material-base-theme-react.jsx`
- Moved all the files from `src/variables/styles/` to `src/assets/theme/material-base-theme/`
